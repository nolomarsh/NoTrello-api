"""
Django settings for NoTrello_api project.
...
SECRET_KEY = 'django-insecure-%u+kz9+odn7$m3nj#-cyledjudbc$%a_c)3w+nzuj)e8rmh@n_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'notrello-backend.herokuapp.com']
...
ROOT_URLCONF = 'NoTrello_api.urls'
...
WSGI_APPLICATION = 'NoTrello_api.wsgi.application'
